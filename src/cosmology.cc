...
inline double E(double z, double Om0) {
  return gsl_sf_exp((1. / 2.) * gsl_sf_log(Om0 * gsl_pow_3(z) + (1. - Om0)));
}

void generate_redshifts(double z_start, double z_end, double grid_size,
                        double h, double Omega_m, std::vector<double> &z) {
